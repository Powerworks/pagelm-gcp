# What makes PageLM any better than LLMs like ChatGPT
...
| **Input Handling**             | Upload multiple files (PDF, DOCX, MD, TXT) and chat _specifically_ about their contents.                                    | File uploads allowed (in Plus/Team), but not optimized for academic workflows or study structure. |
