...
const defaultSuggestions = ['Summarize the key ideas', 'Make a quick quiz', "Explain this like I'm new"];
          ...
          <div className="flex items-center gap-2">
            <span
              className={cx(
                ...
                hasDocument ? 'bg-emerald-500/10 text-emerald-300' : 'bg-stone-800 text-stone-400'
              )}
            >
          ...
          {hasDocument && !messages.length && (
            <div className="space-y-3">
              <div className="text-sm text-stone-300 leading-relaxed">
                Need a quick summary, quiz, or explanation? Ask anything about the current document and I&apos;ll stick
                to that context.
              </div>
