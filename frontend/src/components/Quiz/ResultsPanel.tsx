  ...
  return (
    <div id="resultsScreen" className="text-center space-y-6">
      <div className="bg-stone-950 border border-stone-900 rounded-2xl p-8">
        <div id="resultIcon" className="text-6xl mb-4">
          {visual.icon}
        </div>
        <h2 className="text-3xl font-bold text-white mb-2">Quiz Complete!</h2>
        <p className="text-xl text-stone-300 mb-6">
          Your Score:{' '}
          <span id="finalScore" className="text-blue-400 font-bold">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-2">
          <button
            onClick={onRetake}
            className="bg-stone-900 hover:bg-stone-800 border border-stone-900 hover:border-stone-800 text-stone-200 hover:text-white rounded-xl px-6 py-3 font-medium transition-all duration-300 flex items-center justify-center gap-2"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="size-5"
          ...
          >
            ...
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M2.036 12.322C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178-.07.207-.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z"
              />
          ...
          >
            ...
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M12 6.042A8.967 8.967 0 0 0 6 3.75a8.987 8.987 0 0 0-3 .512v14.25A8.987 8.987 0 0 0 6 18a8.967 8.967 0 0 1 6 2.292m0-14.25A8.966 8.966 0 0 1 18 3.75a8.987 8.987 0 0 1 3 .512v14.25A8.987 8.987 0 0 1 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25"
              />
            </svg>
            New Topic
          </button>
