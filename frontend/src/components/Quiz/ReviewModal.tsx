    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-stone-950 border border-stone-900 rounded-2xl p-6 max-w-2xl w-full">
        <div className="flex items-center justify-between mb-6">
          ...
          <button onClick={onClose} className="p-2 hover:bg-stone-900 rounded-xl transition-all duration-300">
            <svg
              ...
              className="size-6 text-stone-400 hover:text-white"
              fill="none"
              viewBox="0 0 24 24"
              strokeWidth="1.5"
            >
                ...
                <div className="flex items-start gap-3 mb-3">
                  {ok ? (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      className="size-6 text-green-400 flex-shrink-0"
                      fill="currentColor"
                    >
                      <path
                        fillRule="evenodd"
                    ...
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="size-6 text-red-400 flex-shrink-0"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                    >
                      <path
        ...
        <div className="mt-6 flex justify-end">
          <button
            onClick={onClose}
            className="px-5 py-2 rounded-xl bg-stone-900 hover:bg-stone-800 border border-stone-800 text-stone-200 transition-colors"
          >
            Close
          </button>
        </div>
