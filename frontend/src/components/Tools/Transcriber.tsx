...
export default function Transcriber() {
  ...
  const orbSize =
    window.innerWidth < 768 ? Math.min(window.innerWidth * 0.8, 500) : Math.min(window.innerWidth * 0.6, 600);
      ...
      <div className="mt-6 space-y-3">
            ...
            {busy ? (
              ...
              <>
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                  <path
                    fillRule="evenodd"
                    d="M7 4a3 3 0 616 0v4a3 3 0 11-6 0V4zm4 10.93A7.001 7.001 0 0017 8a1 1 0 10-2 0A5 5 0 715 8a1 1 0 00-2 0 7.001 7.001 0 006 6.93V17H6a1 1 0 100 2h8a1 1 0 100-2h-3v-2.07z"
                    clipRule="evenodd"
                  />
                </svg>
                Record Voice
        ...
        {status && (
          ...
          >
            {status}
            {confidence && (
              <span className="block text-sm mt-1 opacity-75">Confidence: {Math.round(confidence * 100)}%</span>
            )}
          </div>
        )}
